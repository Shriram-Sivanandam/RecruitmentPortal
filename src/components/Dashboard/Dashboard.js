      ...
      <div className="card-deck mx-auto my-5">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              The domain for people who want to venture into the various niches
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              This Domain is the Backbone of our community. Learn and understand
              the do's, don'ts, and intricacies of hosting various events,
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text mx-auto">
              This Domain is for those whose creativity has no limits. Create
              Smart and Intuitive Designs that not only plant your ideas but
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header" style={{ backgroundColor: "#232371" }}>
              <h5 class="modal-title mx-auto" style={{ color: "WHITE" }}>
                {" "}
            ...
            <div class="modal-body" style={{ backgroundColor: "#D2D4E3" }}>
              <ol>
                <li>
                  <h6>
                    There will be 2 quizzes - Aptitude (20 questions) and Domain
                    Specific (15 questions)
                  </h6>
                </li>
                <li>
                  <h6>
                    Once you click on next question your response will be
                    automatically saved
                  </h6>
                </li>
                <li>
                  <h6>
                    You cannot go back to the questions you answered or skipped
                    earlier.
                  </h6>
                </li>
              </ol>
